...
/* Accion quehabilita un usuario que esta actualmente deshabilitado. */
public class Habilitar extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        Boolean habilitado = DBMS.getInstance().habilitar(u);
