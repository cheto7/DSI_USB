...
<html>
    ...
    <div id="tabs">
        <ul>
            <li><a href="#tabs-1">Sin revisar</a></li>
            <li><a href="#tabs-2">Revisadas</a></li>
        </ul>
        ...
        <div id="tabs-1">
            <logic:present name="noHayNoModificadas">
                <center>
                    <label>No hay solicitudes pendientes por revisar</label>
                </center>
            </logic:present>
        ...
        <div id="tabs-2">
            <logic:present name="noHayModificadas">
                <center>
                    <label>No hay solicitudes revisadas</label>
                </center>
            </logic:present>
