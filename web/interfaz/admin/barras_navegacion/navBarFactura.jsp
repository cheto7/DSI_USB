<%-- 
    Document   : navBarFactura.jsp
    Created on : Mar 20, 2013, 8:03:55 PM
    Author     : cheto
--%>
...
<ul id="navbar">              
    <p>
       ...
       <li>
        <html:form action="/IrAgregarFactura" onsubmit="return (this)">
            <html:hidden name="autenticado" property="usuario"/>
            <html:submit style="padding:10px 20px 40px 20px">Agregar factura</html:submit>
        </html:form>
        </li> 
        <li>
