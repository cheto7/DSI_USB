...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
    ...
    <center>
        <html:form action="/EvaluarEquipo" onsubmit="return (this)">
            <label>Valoracion del Equipo: </label>
                            <html:hidden name="puntuacion" property="serial"/>
                            <html:hidden name="puntuacion" property="usuario"/>
                            <html:select name="puntuacion" property="puntuacion" styleClass="span1">
                            ...
                            <br/>
                            <br/>
                            <html:submit style="btn btn-primary"> Evaluar </html:submit>
                        </html:form>
</center>        